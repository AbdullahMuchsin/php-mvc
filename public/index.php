...
Route::add("GET", "/user/update-password", UserController::class, "updatePassword", [MustLoginMiddleware::class]);
Route::add("POST", "/user/update-password", UserController::class, "postUpdatePassword", [MustLoginMiddleware::class]);
